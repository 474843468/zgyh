 ...
 */
public class PullDownRefreshLayout extends BaseFrameLayout {
    ...
    private RelativeLayout loadmore_view;//最外层布局
    ...
    public PullDownRefreshLayout(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void initView(Context context) {
        mScrollView = new PullableScrollView(context);
        super.addView(mScrollView);
...
//                pullUpView.startAnimation(reverseAnimation);
    ...
    public void setBackgroundColor(int i){
        //1为从贵金属积存进入，背景显示黄色
        if(i==1){
            loadmore_view.setBackgroundColor(getResources().getColor(R.color.goldstore_color));
        }
...
//            loadingResultView.setBackgroundResource(R.drawable.load_success_new);
            ...
            loadingResultView.setBackgroundResource(R.drawable.load_fail_new);
            loadingResultView.setVisibility(View.VISIBLE);
        }
    ...
    private void initView() {
        ...
        pullUpView.setBackgroundResource(R.drawable.loading_new);
        ...
        loadmore_view=(RelativeLayout)loadmoreView.findViewById(R.id.loadmore_view);
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        mScrollView.layout(0, (int) pullUpY, mScrollView.getMeasuredWidth(), (int) pullUpY + mScrollView.getMeasuredHeight());
