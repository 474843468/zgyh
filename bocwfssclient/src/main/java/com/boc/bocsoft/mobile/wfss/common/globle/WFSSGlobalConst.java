package com.boc.bocsoft.mobile.wfss.common.globle;
 ...
 * @date 2016.10.25
 */
public class WFSSGlobalConst {

    /**
     * 设置头信息上送项
     */
    public static String CLENTID = "BOCOVSaPhoneBank";// 表示产品名称
    public static String AGENT = "X-ANDR";// agent:
    ...
    public static final String WFSS_COMM = "comm/";//通用模块url
    public static final String WFSS_FUND = "fund/";//基金模块url
    public static final String WFSS_FOREX = "forex/";//外汇、贵金属模块url
