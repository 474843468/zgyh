package com.boc.bocsoft.mobile.bocmobile.buss.wealthmanagement.mypositions.financialposition.model.psnxpadreferprofitquery;

import java.io.Serializable;

/**
 * PsnXpadReferProfitQuery  参考收益汇总查询   返回Model
 * 是否需要申请Conversation	False
 * Created by zn on 2016/9/19.
 */
public class PsnXpadReferProfitQueryResModel implements Serializable {
    //    ============================产品性质：1-类基金理财产品=====字段==================================
    /**
     * 收益日期	String
     */
