 ...
 */
public class TransInquirePresenter implements TransInquireContact.Presenter {
    private TransInquireContact.View mView;
    private RxLifecycleManager mRxLifecycleManager;

    private GlobalService globalService;
    private WealthManagementService wealthManagementService;

    public TransInquirePresenter(TransInquireContact.View view) {
        this.mView = view;
