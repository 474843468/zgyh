...
public class SlipDrawerLayout extends DrawerLayout {
    ...
    private OnDrawerStateListener listener;
...
//        }
    ...
    private class DrawerLayoutStateListener extends SimpleDrawerListener {
        ...
        public void onDrawerClosed(View drawerView) {
            ...
            setDrawerLockMode(DrawerLayout.LOCK_MODE_LOCKED_CLOSED);
            if (listener != null)
                listener.onDrawerStateChange(isOpen);
        }
    }

    public void setOnDrawerStateListener(OnDrawerStateListener listener) {
        this.listener = listener;
    }

    public interface OnDrawerStateListener {
        void onDrawerStateChange(boolean isOpen);
    }
