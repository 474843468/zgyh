...
import com.boc.bocsoft.mobile.bocmobile.buss.longshortforex.accountmanagement.ui.ChooseLongshortAccountContact;
 ...
 */
public class ChooseLongshortAccountPresenter extends RxPresenter implements ChooseLongshortAccountContact.Presenter {
    private ChooseLongshortAccountContact.View mView;
    private RxLifecycleManager mRxLifecycleManager;
    private LongShortForexService longShortForexService;

    public ChooseLongshortAccountPresenter(ChooseLongshortAccountContact.View view) {
        this.mView = view;
