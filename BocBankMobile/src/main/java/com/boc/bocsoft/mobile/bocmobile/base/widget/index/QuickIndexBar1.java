 ...
 */
public class QuickIndexBar1 extends View {
    private String[] indexArr = {"常用", "A", "B", "C", "D", "E", "F", "G", "H", "I",
    ...
    public QuickIndexBar1(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init(context, attrs);
    }

    public QuickIndexBar1(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public QuickIndexBar1(Context context) {
        this(context, null);
    }
...
//            if (i == 0) {
//                Bitmap bitmap = BitmapFactory.decodeResource(getResources(), R.drawable.boc_image_search);
//                canvas.drawBitmap(bitmap, x - 10, 8, paint);
//            } else {
