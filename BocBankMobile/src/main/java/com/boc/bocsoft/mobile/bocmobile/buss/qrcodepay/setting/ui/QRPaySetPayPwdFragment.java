 ...
 */
public class QRPaySetPayPwdFragment extends BussFragment implements QRPayPwdContract.QrPaySecurityFactorView, QRPayPwdContract.QrPaySetPwdView,
    ...
    private QRPayPwdPresenter qrPaySetPwdPresenter;

    private QRPaySetPwdViewModel qrPaySetPwdViewModel;
    ...
    protected String getTitleValue() {
        return getResources().getString(R.string.boc_qrpay_set_pay_pwd);
    }
    ...
    public void initData() {
        ...
        qrPaySetPwdPresenter = new QRPayPwdPresenter((QRPayPwdContract.QrPaySetPwdView)this);

        qrPaySetPwdViewModel = new QRPaySetPwdViewModel();
    ...
    public void setListener() {
        ...
        btnConfirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (checkViewRegex()) {
                    showLoadingDialog();
                    qrPaySetPwdPresenter.loadQRPaySetPassPre(buildSetPassPreViewModel());
                }
            }
        });
    }
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        SecurityVerity.getInstance(getActivity()).setSecurityVerifyListener(QRPaySetPayPwdFragment.this);
    }
     ...
     * 封装设置支付密码 预交易 数据
     */
    private QRPaySetPwdViewModel buildSetPassPreViewModel() {
     ...
     * 封装设置支付密码 提交交易 数据
     */
    private QRPaySetPwdViewModel buildSetPassViewModel(int factorId, String[] randomNums, String[] encryptPasswords){
...
//        sipBoxPayPwd.setOutputValueType(ApplicationConst.OUT_PUT_VALUE_TYPE_OTP);
        //设置为全键盘 0 全键盘  1 数字键盘
...
//        sipBoxPayPwdAgain.setOutputValueType(ApplicationConst.OUT_PUT_VALUE_TYPE_OTP);
        //设置为全键盘 0 全键盘  1 数字键盘
    ...
    public void loadQRPaySetPassSuccess() {
        ...
        if (QRPayScanFragment.SCAN_FROM_SCAN == getArguments().getInt(QRPayScanFragment.SCAN_FROM_KEY, -1)){
            ...
            bundle.putInt(QRPaySetResultFragment.QRPAY_RESULT_KEY, QRPaySetResultFragment.QRPAY_PWD_SET_SUCCESS);
            ...
            startWithPop(QRPaySetResultFragment.newInstance(QRPaySetResultFragment.QRPAY_PWD_SET_SUCCESS));
        }
    }
    ...
    public void onEncryptDataReturned(String factorId, String[] randomNums, String[] encryptPasswords) {
        showLoadingDialog();
        // 设置支付密码
        qrPaySetPwdPresenter.loadQRPaySetPass(buildSetPassViewModel(Integer.valueOf(factorId), randomNums, encryptPasswords));
    }
    ...
    public void onSignedReturn(String signRetData) {
        ...
        // 设置支付密码
        qrPaySetPwdPresenter.loadQRPaySetPass(buildSetPassViewModel(SecurityVerity.SECURITY_VERIFY_E_TOKEN, randomNums, encryptPasswords));
    }
