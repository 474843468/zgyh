 ...
 * 用途：行前准备
 */
public class NounStudyPreGoFragment extends BussFragment {
    private View mRootView = null;
    ListView listView;
    String stss[] = {"行前准备阶段","行前准备时所需的金融服务","出国留学问答","抵境小贴士"};
    String ss[] = {"","service","qa","tips"};
    String url = OverseasConst.OVERSEA_PRE_GO;
