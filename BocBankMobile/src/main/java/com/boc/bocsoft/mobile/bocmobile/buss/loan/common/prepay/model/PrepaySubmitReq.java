...
public class PrepaySubmitReq {
    ...
    public String toString() {
        return "PrepaySubmitReq{" +
                ...
                ", advanceRepayInterest=" + advanceRepayInterest +
                ", advanceRepayCapital=" + advanceRepayCapital +
                ...
                ", afterRepayissueAmount=" + afterRepayissueAmount +
                ", interestType='" + interestType + '\'' +
                ", afterRepayRemainAmount=" + afterRepayRemainAmount +
                ", afterRepayissues='" + afterRepayissues + '\'' +
