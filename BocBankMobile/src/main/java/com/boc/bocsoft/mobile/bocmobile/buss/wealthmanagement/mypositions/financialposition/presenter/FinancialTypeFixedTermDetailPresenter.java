 ...
 * 中银理财-持仓详情（
 * 日积月累）-Contract
 * Created by cff on 2016/9/24.
 */
public class FinancialTypeFixedTermDetailPresenter extends RxPresenter implements FinancialPositionContract.FinancialTypeFixedTermDetailPresenter {
    /**
     * 中银理财-service
     */
     ...
     * 持仓列表-接口回调
     */
    private FinancialPositionContract.FinancialTypeFixedTermDetailView mFinancialDetailView;
    /***
     * 持仓列表-model 转换工具类
     */
     ...
     */
    public FinancialTypeFixedTermDetailPresenter(FinancialPositionContract.FinancialTypeFixedTermDetailView mFinancialDetailView) {
