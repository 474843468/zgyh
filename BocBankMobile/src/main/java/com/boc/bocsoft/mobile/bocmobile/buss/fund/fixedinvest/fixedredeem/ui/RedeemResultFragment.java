...
public class RedeemResultFragment extends BussFragment implements OnItemClickListener,ResultBottom.OnClickListener,BaseResultView.HomeBackListener {
    ...
    private void displayResultView(){
        rootView.addStatus(ResultHead.Status.SUCCESS, getString(R.string.boc_fund_fixedinvest_sell_success_hint));
        //需要格式化
        String sellAmount = MoneyUtils.transMoneyFormat(mSellData.getApplyAmount(),mSellData.getCurrency());
        rootView.addTitle(getString(R.string.boc_fund_fixedinvest_sell_tan_amount_unit,sellAmount));

        LinkedHashMap<String, String> map = new LinkedHashMap<>();
        //订赎日期
        String sellDate = mSellData.getSubDate();
        map.put(getString(R.string.boc_fund_fixedinvest_sell_tran_data),sellDate);
        //基金交易账户
        ...
        map.put(getString(R.string.boc_fund_fixedinvest_sell_tran_amount),tranAccount);
        //赎回方式
