package com.boc.bocsoft.mobile.bocmobile.base.widget.banner.adapter;
...
//        if(onItemClickListener != null) view.setOnClickListener(onItemClickListener);
    ...
    public View getView(int position, View view, ViewGroup container) {
        ...
        if (view == null) {
            ...
            view.setTag(R.id.boc_banner_item_tag, holder);

        } else {
            holder = (Holder<T>) view.getTag(R.id.boc_banner_item_tag);
        }
