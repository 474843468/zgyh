package com.boc.bocsoft.mobile.bocmobile.base.widget.banner;
...
import com.boc.bocsoft.mobile.bocmobile.base.widget.banner.adapter.BannerPageAdapter;
import com.boc.bocsoft.mobile.bocmobile.base.widget.banner.holder.BannerViewHolderCreator;
import com.boc.bocsoft.mobile.bocmobile.base.widget.banner.listener.BannerPageChangeListener;
import com.boc.bocsoft.mobile.bocmobile.base.widget.banner.listener.OnItemClickListener;
import com.boc.bocsoft.mobile.bocmobile.base.widget.banner.view.BannerLoopViewPager;
...
public class ConvenientBanner<T> extends LinearLayout {
    ...
    public ConvenientBanner(Context context, AttributeSet attrs) {
        super(context, attrs);
        TypedArray a = context.obtainStyledAttributes(attrs,R.styleable.BocConvenientBanner);
        canLoop = a.getBoolean(R.styleable.BocConvenientBanner_canLoop,true);
        a.recycle();
        init(context);
    }
    ...
    private void init(Context context) {
        View hView = LayoutInflater.from(context).inflate(
                R.layout.boc_viewpager_banner, this, true);
        viewPager = (BannerLoopViewPager) hView.findViewById(R.id.cbLoopViewPager);
     ...
     * @return
     */
    public ConvenientBanner setPages(BannerViewHolderCreator holderCreator, List<T> datas){
        // 页面数据
        this.mDatas = datas;
        // 页面显示适配器
