 ...
 */
public class PsnXpadQuantityDetailResModel implements Serializable {
    /**
     * 份额总笔数	String
     */
    ...
    public static class ListEntity implements Serializable{
        ...
        public String toString() {
            return "ListEntity{" +
                    ...
                    ", progressionflag='" + progressionflag + '\'' +
                    ...
                    ", canAssignDate='" + canAssignDate + '\'' +
                    ", shareValue='" + shareValue + '\'' +
                    ", yearlyRRMax='" + yearlyRRMax + '\'' +
                    ", issueType='" + issueType + '\'' +
                    ", xpadAccount='" + xpadAccount + '\'' +
                    ...
                    ", canRedeem='" + canRedeem + '\'' +
                    ", canPartlyRedeem='" + canPartlyRedeem + '\'' +
                    ", lowestHoldQuantity='" + lowestHoldQuantity + '\'' +
                    ", redeemStartingAmount='" + redeemStartingAmount + '\'' +
                    ", cashRemit='" + cashRemit + '\'' +
                    ", expProfit='" + expProfit + '\'' +
                    ", canQuantityExchange='" + canQuantityExchange + '\'' +
                    ", productTerm='" + productTerm + '\'' +
                    ", canAgreementMange='" + canAgreementMange + '\'' +
                    ", currPeriod='" + currPeriod + '\'' +
                    ", totalPeriod='" + totalPeriod + '\'' +
                    ", prodBegin='" + prodBegin + '\'' +
                    ", tranSeq='" + tranSeq + '\'' +
                    ", bancAccountKey='" + bancAccountKey + '\'' +
                    '}';
        }
