 ...
 * 留学贷介绍页面
 */
public class StudyaboardLoanFragment extends BussFragment {
    ...
    protected  View onCreateView(LayoutInflater mInflater){
        mRootView = mInflater.inflate(R.layout.fragment_studyloan,null);
        return mRootView;
    }
    ...
    public void initView(){
        ...
        btnApplyLoan = (Button)mRootView.findViewById(R.id.study_btn);
    ...
    public void setListener() {
        ...
        btnApplyLoan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                bundle.putString(ConsumefinanceConst.PAGE_CONSUEMFINANCE,"fromStudyloan");
