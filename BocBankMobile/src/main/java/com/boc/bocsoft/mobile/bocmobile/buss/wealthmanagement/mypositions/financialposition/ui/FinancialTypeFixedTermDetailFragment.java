...
import com.boc.bocsoft.mobile.bocmobile.base.widget.details.DetailFinancialTabRowTextButton;
...
/**
 * 持仓详情-日积月累固定收益
 * Created by cff on 2016/9/18.
 */
public class FinancialTypeFixedTermDetailFragment extends MvpBussFragment<FinancialTypeFixedTermDetailPresenter> implements View.OnClickListener, FinancialPositionContract.FinancialTypeFixedTermDetailView {
    ...
    //参考收益
    private TextView fixedterm_currentcode;
    //继续购买得到数据
    ...
    //产品名称和产品代码 所在view
    private DetailFinancialTabRowTextButton mDetailFinancialTabRowTextButton = null;
    // ====================view定义=================end===========
    // ===================接口code===============start=============
    ...
    //继续购买跳转Fragment
    private PurchaseFragment goonFragment;
    //产品详情
    ...
    protected View onCreateView(LayoutInflater mInflater) {
        mRootView = mInflater.inflate(R.layout.fragment_fixedtermdetail, null);
        return mRootView;
    }
    ...
    protected View getTitleBarView() {
        if ("1".equals(banlanceDeta.getCanAgreementMange())) {
            ...
            //投资协议点击事件
            titleBarView.setRightButton(getResourceString(R.string.boc_trans_financial_fixedterm_agteement), new View.OnClickListener() {
                @Override
    ...
    public void initView() {
        ...
        fixedterm_currentcode = (TextView) mRootView.findViewById(R.id.fixedterm_currentcode);
    }
    ...
    public void initData() {
        ...
        if ("0".equals(banlanceDeta.getCanChangeBonusMode())) {
            ...
            mDetailTabRowTextButton = detailContent.addTextCntent(getResourceString(R.string.boc_trans_financial_position_shareouttype), getCurrentBonusModeType(banlanceDeta.getCurrentBonusMode()), "更改", new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    //更改点击事件
                    showYearlyDialog();
        ...
        fixedterm_currentcode.setText(getString(R.string.boc_trans_financial_position_main_reference) + getCashInfo());
        //判断是否可赎回
...
//            }
    ...
    private String getFixedTermInfo() {
        String info = getResourceString(R.string.boc_trans_financial_fixedterm_info);
        String info1 = "";
        String info2 = "";
        String info3 = "";
        String info4 = "";
        info1 = info.replace("{1}", fixedrefit_info.getIntsdate() + "");
//        if("-1".equals(banlanceDeta.getProdEnd())){
//            info2=info1.replace("{2}",getResourceString(R.string.boc_trans_financial_fixedterm_unlimited));
//        }else{
        info2 = info1.replace("{2}", fixedrefit_info.getIntedate() + "");
//        }
        info3 = info2.replace("{3}", MoneyUtils.transMoneyFormat(fixedrefit_info.getProfit() + "", banlanceDeta.getCurCode()) + "");
        info4 = info3.replace("{4}", MoneyUtils.transMoneyFormat(fixedrefit_info.getTotalprofit() + "", banlanceDeta.getCurCode()) + "");
        return info4;
    }
