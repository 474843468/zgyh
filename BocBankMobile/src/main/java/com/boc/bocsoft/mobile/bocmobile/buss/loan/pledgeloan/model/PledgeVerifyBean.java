...
/**
 * 作者：XieDu
 * 创建时间：2016/8/18 16:39
 * 描述：
 */
public class PledgeVerifyBean implements Parcelable {
    /**
     * CA加签数据XML报文
     */
    ...
    public PledgeVerifyBean() {}

    protected PledgeVerifyBean(Parcel in) {
    ...
    public static final Parcelable.Creator<PledgeVerifyBean> CREATOR =
            new Parcelable.Creator<PledgeVerifyBean>() {
                @Override
                public PledgeVerifyBean createFromParcel(
                        Parcel source) {return new PledgeVerifyBean(source);}

                @Override
                public PledgeVerifyBean[] newArray(int size) {return new PledgeVerifyBean[size];}
            };
}
