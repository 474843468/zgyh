 ...
 * 055定赎详情
 */
public class InvestSellDetailModel implements Serializable {
    /**基金代码*/
    ...
    /**是否定赎修改传值*/
    private boolean isRedeemUpdate;

    public boolean isRedeemUpdate() {
        return isRedeemUpdate;
    }

    public void setRedeemUpdate(boolean redeemUpdate) {
        isRedeemUpdate = redeemUpdate;
    }
