 ...
 */
public class XpadAutTradStatusViewModel {
    ...
    private List<AutTradEntitiy> autTradList;

    private int recordNumber;

    public List<AutTradEntitiy> getAutTradList() {
        return autTradList;
    }

    public void setAutTradList(List<AutTradEntitiy> autTradList) {
        this.autTradList = autTradList;
    }
    ...
    public static class AutTradEntitiy implements Parcelable, Comparable<AutTradEntitiy> {
        ...
        public void writeToParcel(Parcel dest, int flags) {
            ...
            dest.writeString(this.tranAtrr);
            dest.writeString(this.canBeCanceled);
            dest.writeString(this.isReciveMoney);
            dest.writeString(this.accountNumber);
            dest.writeString(this.accountKey);
            dest.writeSerializable(this.futureDate);
            dest.writeString(this.entrustType);
            dest.writeString(this.tranSeq);
            dest.writeString(this.productKind);
            dest.writeString(this.standardPro);
        }

        public AutTradEntitiy() {
        }

        private AutTradEntitiy(Parcel in) {
            this.paymentDate = (LocalDate) in.readSerializable();
            this.prodCode = in.readString();
            this.prodName = in.readString();
            this.trfType = in.readString();
            ...
            this.tranAtrr = in.readString();
            this.canBeCanceled = in.readString();
            this.isReciveMoney = in.readString();
            this.accountNumber = in.readString();
            this.accountKey = in.readString();
            this.futureDate = (LocalDate) in.readSerializable();
            this.entrustType = in.readString();
            this.tranSeq = in.readString();
            this.productKind = in.readString();
            this.standardPro = in.readString();
        }

        public static final Parcelable.Creator<AutTradEntitiy> CREATOR = new Parcelable.Creator<AutTradEntitiy>() {
            public AutTradEntitiy createFromParcel(Parcel source) {
                return new AutTradEntitiy(source);
            }

            public AutTradEntitiy[] newArray(int size) {
                return new AutTradEntitiy[size];
            }
        };

        @Override
        public int compareTo(AutTradEntitiy another) {
            LocalDate thisDate = this.getFutureDate();
            LocalDate anotherDate = another.getFutureDate();
