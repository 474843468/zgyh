 ...
 * 还款记录滑动适配器
 */
public class RepaymentAdapter extends FragmentPagerAdapter {
    private ArrayList<Fragment> fragmentsList;
    private ArrayList<String> titleList;

    public RepaymentAdapter(FragmentManager fm) {
        super(fm);
        fragmentsList = new ArrayList<Fragment>();
        titleList = new ArrayList<String>();
    }

    public RepaymentAdapter(FragmentManager fm, ArrayList<Fragment> fragmentsList) {
        super(fm);
        this.fragmentsList = fragmentsList;
    }

    public RepaymentAdapter(FragmentManager fm, ArrayList<String> titleList, ArrayList<Fragment> fragmentsList) {
        super(fm);
        this.fragmentsList = fragmentsList;
