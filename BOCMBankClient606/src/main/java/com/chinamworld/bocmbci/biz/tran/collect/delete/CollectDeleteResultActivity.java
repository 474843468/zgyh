...
/**
 * @ClassName: CollectDeleteResultActivity
 * @Description: 资金归集删除结果页面
 * @author luql
 * @date 2014-4-3 上午09:25:09
 */
public class CollectDeleteResultActivity extends CollectBaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mViewContent = addView(R.layout.collect_delete_result_activity);
	...
	private void findView() {
		// /** 归集编号 */
		// TextView rulenNoView = (TextView)
		// mViewContent.findViewById(R.id.tv_rulenno);
		/** 归集账户 */
		...
		String mIfMessageParam = intent.getStringExtra(Collect.ifMessage);
		...
		if (CollectImputationMode.ALL.equals(imputationModeCodeParam)) {
			...
			retainAmountView.setText(amountParam);
