 ...
 * 
 */
public class CashAcctTransDetailAdapter extends BaseAdapter {
	...
	public CashAcctTransDetailAdapter(Context context,
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		tv_acc_query_result_businessDigest.setText(StringUtil
				...
				: LocalData.bocnetTransferType.get(businessDigest));

		return convertView;
	}
	
	public void setDatas(List<Map<String, Object>> transferList){
		this.transferList = transferList;
