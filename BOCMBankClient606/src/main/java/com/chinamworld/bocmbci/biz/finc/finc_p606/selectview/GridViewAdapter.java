...
public class GridViewAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.finc_select_item_grid_view, parent, false);
    ...
    private void setBackground(boolean isSelected, TextView v) {
        if (isSelected) {
            v.setBackgroundDrawable(context.getResources().getDrawable(R.drawable.finc_textview_bg_light));
            Drawable select = context.getResources().getDrawable(R.drawable.finc_check_box_true);
            v.setCompoundDrawablesWithIntrinsicBounds(select, null, null, null);
        } else {
            v.setBackgroundDrawable(context.getResources().getDrawable(R.drawable.finc_textview_bg_default));
