 ...
 *
 */
public class FincTradeProtocolActivity extends BaseActivity {// implements
																	// OnClickListener
																	// {

	private RelativeLayout rl_bank;
	private RelativeLayout view;
	private TextView contract_title_tv;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		contract_title_tv=(TextView) findViewById(R.id.contract_title_tv);
		contract_title_tv.setText("电子合同书");
	}
...
//			readHtmlFromAssets("file:///android_asset/page/sbremit_protocol.htm");
			webView.loadUrl("http://www.boc.cn/1234567890.html");
			return contentView;
		}
