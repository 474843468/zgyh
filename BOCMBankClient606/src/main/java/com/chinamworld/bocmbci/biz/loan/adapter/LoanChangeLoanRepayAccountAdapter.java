...
public class LoanChangeLoanRepayAccountAdapter extends BaseAdapter {
	private List<Map<String, String>> list = null;
	private Context context = null;
	public static int selection = -1;

	public LoanChangeLoanRepayAccountAdapter(Context context, List<Map<String, String>> list) {
		this.list = list;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			holder.loanRepayMoney = (TextView) convertView.findViewById(R.id.loan_repay_money);
		...
		holder.loanRepayMoney.setText(R.string.loan_amount);
		return convertView;
	}
	...
	private class ViewHolder {
		...
		private TextView loanRepayMoney = null;
