 ...
 * 
 */
public class AccICCardSuccessActivity extends AccBaseActivity {
	/** IC卡关联成功页 */
	private View view;
	/** 待关联账户类型 */
...
//				.get(Acc.RELEVANCEACCPRE_ACC_RELEVANCECREDITACCOUNTTYPE_RES);
		relevance_type=(String)preResultMap.get(Acc.RELEVANCEACCPRE_ACC_ACCOUNTTYPE_RES);
		acc_relevance_type
