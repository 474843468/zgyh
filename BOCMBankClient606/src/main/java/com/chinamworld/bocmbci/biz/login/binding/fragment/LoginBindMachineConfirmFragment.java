...
public class LoginBindMachineConfirmFragment extends SettingBaseFragment implements
		OnClickListener {
	...
	public LoginBindMachineConfirmFragment(String securityFactorId,
	...
	private void initDatas() {
		...
		// securityFactorId = bundle.getString("security_factor_id");
		// ObjectValueSerializable map = (ObjectValueSerializable)
...
//			smcSipBox.setRandomKey_S(settingControl.randomNumber);
	...
	private void setViews() {
		...
		((LoginBindingActivity)getActivity()).leftBtnClickType = "go_pre";
		((LoginBindingActivity)getActivity()).setLeftBtnVisible();
...
//		}
	...
	public void bindConfirmRegisterDeviceCallback(Object resultObj) {
		...
		((LoginBindingActivity)getActivity()).leftBtnClickType = "go_main";
		// TODO 绑定成功后，判断是否已激活，未激活则显示绑定成功未激活页面，已激活则显示已激活页面
		((LoginBindingActivity) getActivity())
				.showFragment(new LoginBindMachineResultFragment());
	}
