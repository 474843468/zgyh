...
public class LiveSourceActivity extends ServiceRecordBaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (isAvilible(LiveSourceActivity.this, "com.forms")) {
			liveisdown = true;
		}
	...
	class InflaterViewDialog {
		...
		public View initMessageDialogView(Activity act,
			...
			contentView = LayoutInflater.from(currentContent).inflate(
					R.layout.live_source_protocol, null);
			...
			down = (TextView) contentView.findViewById(R.id.down_live);
			if (liveisdown) {
				...
				down.setOnClickListener(new OnClickListener() {
					...
					public void onClick(View arg0) {
						...
						LiveSourceActivity.this.startActivity(LiveSourceActivity.this.getPackageManager()
			...
			readHtmlFromAssets("file:///android_asset/page/live_protocol.htm");
