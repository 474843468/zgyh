 ...
 * 
 */
public class MyFinanceIcAccountTransferDetailActivity extends AccBaseActivity
	...
	/** 选择的币种 */
	private String currency = LocalData.queryCurrencyList.get(0);
	/** 选择的钞汇 */
	private String cashremit = LocalData.nullcashremitList.get(0);
	/** 选择的开始日期 */
...
//		PopupWindowUtils.getInstance().showQueryPopupWindowFirst();
	...
	public void initfirst() {
		...
		PopupWindowUtils.getInstance().setOnPullSelecterListener(
				MyFinanceIcAccountTransferDetailActivity.this, ll_sort,
	...
	public void queryDetail() {
		...
		if (QueryDateUtils.compareDateOneYear(startdate, dateTime)) {
			...
			BaseDroidApp.getInstanse().showInfoMessageDialog(
					MyFinanceIcAccountTransferDetailActivity.this
		...
		public void onClick(View v) {
			...
			case R.id.tv_text2:
				...
				FinanceIcAccountTransferAdapter indetailadapter = new FinanceIcAccountTransferAdapter(
						MyFinanceIcAccountTransferDetailActivity.this, listIn);
			...
			case R.id.tv_text3:
				...
				FinanceIcAccountTransferAdapter outdetailadapter = new FinanceIcAccountTransferAdapter(
						MyFinanceIcAccountTransferDetailActivity.this, listOut);
...
//			PopupWindowUtils.getInstance().dissMissQueryPopupWindow();
			...
			detailadapter = new FinanceIcAccountTransferAdapter(
					MyFinanceIcAccountTransferDetailActivity.this, transferList);
			lv_acc_query_result.setAdapter(detailadapter);
