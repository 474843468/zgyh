 ...
 * 
 */
public class HistoryTradeActivity extends ThirdManagerBaseActivity implements OnClickListener {
	/** 主布局 */
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		addView(viewContent);
		setTitle(this.getString(R.string.third_history));
		btnRight.setVisibility(View.GONE);

		findView();
		setLeftSelectedPosition("thirdMananger_2");
...
//		BaseHttpEngine.showProgressDialogCanGoBack();
	...
	private void findView() {
		...
		textTip.setText(this.getString(R.string.third_platfor_card_tip));
	...
	public void onClick(View v) {
		...
		if (selectposition > -1) {
			...
			it.setClass(this, HistoryTradeQueryActivity.class);
...
//							.get(Comm.ACCOUNTNUMBER));
	...
	public void allBankAccListCallBack(Object resultObj) {
		...
		mAdapter = new AccOpenCardAdapter(HistoryTradeActivity.this, bankAccountList);
