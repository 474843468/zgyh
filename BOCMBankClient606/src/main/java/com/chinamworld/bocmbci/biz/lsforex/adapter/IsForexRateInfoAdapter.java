...
/** 双向宝行情页面  适配器*/
public class IsForexRateInfoAdapter extends BaseAdapter {

	private final String TAG = "IsForexRateInfoAdapter";
	...
	public IsForexRateInfoAdapter(Context context, List<Map<String, Object>> list) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = LayoutInflater.from(context).inflate(R.layout.isforex_rate_main_item, null);
...
//			holder.button = (ImageView) convertView.findViewById(R.id.rate_gotoDetail);
		...
		// //////////////////////////////////////////////////////////////////
		// add by luqp 2015年11月23日16:22:48 添加阴阳格
		if (position % 2 != 0) {
...
//		holder.button.setTag(position);
		...
		/** X-FUND涨跌标志*/
		String flag = (String) map.get(IsForex.ISFOREX_FLAG_RES);
		...
		String buyRate = (String) map.get(IsForex.ISFOREX_BUYRATE_RES);
		holder.buyRate.setText(buyRate);

		String sellRate = (String) map.get(IsForex.ISFOREX_SELLRATE_RES);
