...
public class ImpotantFousActivity extends SBRemitBaseActivity {
	...
	private void initViews() {
		...
		String identityNumberNew = ToDBC(custnameString + "(身份证号码"
				+ identityNumber + ")"+",被列为个人外汇管理“预关注对象”");
		// 拼接第一行的字符串
		messagefirst.setText(ToDBC(custName+"("+"身份证件号码："+identityNumber+")"+":"));
		// 拼接第二行的字符串
		String messagedStringate = pubDate + "至" + endDate;
	...
	private void init() {
		...
		view = LayoutInflater.from(this).inflate(
				R.layout.important_focus_dialog, null);
	...
	//倒计时10秒钟
	  CountDownTimer timer=new CountDownTimer(11000, 1000) {
			...
			public void onTick(long arg0) {
				...
				// "<font color=\"#ba001d\">";;;<span
				// style="font-weight:bold;">加粗</span>
				String string = "<font color=\"#ba001d\">"+ arg0/1000 + "</font>";
