...
/**
 * Atm取款list适配器 可进行单项选择
 * 
 * @author wangmengmeng
 * 
 */
public class AtmChooseAccountAdapter extends BaseAdapter {
	/** 账户列表信息 */
	...
	public AtmChooseAccountAdapter(Context context,
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			/** 账户类型 */
			holder.tv_acc_type_value = (TextView) convertView
					.findViewById(R.id.acc_type_value);
			/** 账户别名 */
			holder.tv_acc_account_nickname = (TextView) convertView
					.findViewById(R.id.acc_account_nickname);
			/** 账户账号 */
			holder.tv_acc_account_num = (TextView) convertView
		...
		holder.tv_acc_type_value.setText(LocalData.AccountType.get(acc_type
				.trim()));

		holder.tv_acc_account_nickname.setText(String.valueOf(bankAccountList
				.get(position).get(Acc.ACC_NICKNAME_RES)));

		String acc_account_num = String.valueOf(bankAccountList.get(position)
				.get(Acc.ACC_ACCOUNTNUMBER_RES));
		holder.tv_acc_account_num.setText(StringUtil
