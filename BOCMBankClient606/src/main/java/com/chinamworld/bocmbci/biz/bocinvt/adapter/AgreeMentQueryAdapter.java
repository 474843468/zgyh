 ...
 * 
 */
public class AgreeMentQueryAdapter extends BaseAdapter {
	/** 查询结果列表信息 */
	private List<Map<String, Object>> agreeQueryList;
	private Context context;

	public AgreeMentQueryAdapter(Context context,
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		viewHolder.tv_number.setText(String.valueOf(agreeQueryList
				.get(position).get(BocInvt.BOC_QUERY_AGREE_CONTRACTSEQ_RES)));
		String currency = (String) agreeQueryList.get(position).get(
				BocInvt.BOC_AUTO_CURCODE_REQ);
