...
/**
 * @ClassName: GatherQueryActivity
 * @Description: 收款指令查询页面
 * @author JiangWei
 * @date 2013-8-20上午10:24:02
 */
public class GatherQueryActivity extends GatherBaseActivity implements
		OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setLeftSelectedPosition("GatherInitiative_1");
		...
		if (btnRight != null) {
			btnRight.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					...
					intent.setClass(GatherQueryActivity.this,
...
//				PopupWindowUtils.getInstance().showQueryPopupWindow();
		...
		btnMore.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				requestPsnTransActQueryReminderOrderList();
			}
		});
...
//				onClickCondition();
	...
	OnClickListener chooseDateClick = new OnClickListener() {
		...
		public void onClick(final View v) {
			...
			DatePickerDialog dialog = new DatePickerDialog(
					GatherQueryActivity.this, new OnDateSetListener() {
	...
	private OnItemClickListener listViewItemClickListener = new OnItemClickListener() {
		...
		public void onItemClick(AdapterView<?> parent, View view, int position,
				long id) {
			requestPsnTransActReminderOrderDetail(position);
	 ...
	 * @Description: 请求“收款指令查询”接口
	 * @param
	 * @return void
	 * @throws
	 */
	public void requestPsnTransActQueryReminderOrderList() {
		BaseHttpEngine.showProgressDialog();
		BiiRequestBody biiRequestBody = new BiiRequestBody();
		biiRequestBody
				.setMethod(GatherInitiative.PSN_TRANS_ACT_QUERY_REMINDER_ORDER_LIST);
		...
		HttpManager.requestBii(biiRequestBody, this,
				"requestPsnTransActQueryReminderOrderListCallback");
	}

	/**
	 * @Title: requestPsnTransActQueryReminderOrderListCallback
	 * @Description: 请求“收款指令查询”接口回调
	 * @param @param resultObj
	 * @return void
	 * @throws
	 */
	@SuppressWarnings("unchecked")
	public void requestPsnTransActQueryReminderOrderListCallback(
			Object resultObj) {
		BaseHttpEngine.dissMissProgressDialog();
...
//		closeQuerWindow();
	 ...
	 * @Description: 请求“收款指令详情”接口
	 * @param position
	 *            当前需要查询条目的position
	 * @return void
	 * @throws
	 */
	private void requestPsnTransActReminderOrderDetail(int position) {
		BaseHttpEngine.showProgressDialog();
		BiiRequestBody biiRequestBody = new BiiRequestBody();
		biiRequestBody
				.setMethod(GatherInitiative.PSN_TRANS_ACT_REMINDER_ORDER_DETAIL);
		// biiRequestBody.setConversationId((String)
		// BaseDroidApp.getInstanse().getBizDataMap()
		// .get(ConstantGloble.CONVERSATION_ID));
		Map<String, Object> map = new HashMap<String, Object>();
		...
		biiRequestBody.setParams(map);
		HttpManager.requestBii(biiRequestBody, this,
				"requestPsnTransActReminderOrderDetailCallback");
	}

	/**
	 * @Title: requestPsnTransActReminderOrderDetailCallback
	 * @Description: 请求“收款指令详情”接口的回调
	 * @param @param resultObj
	 * @return void
	 * @throws
	 */
	@SuppressWarnings("unchecked")
	public void requestPsnTransActReminderOrderDetailCallback(Object resultObj) {
		BaseHttpEngine.dissMissProgressDialog();
		BiiResponse biiResponse = (BiiResponse) resultObj;
		List<BiiResponseBody> biiResponseBodys = biiResponse.getResponse();
		BiiResponseBody biiResponseBody = biiResponseBodys.get(0);
		...
		Intent intent = new Intent(this, GatherQueryDetailActivity.class);
		startActivityForResult(intent, 101);
	}
