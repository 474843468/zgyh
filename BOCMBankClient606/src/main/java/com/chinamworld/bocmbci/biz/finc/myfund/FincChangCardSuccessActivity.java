 ...
 * 
 */
public class FincChangCardSuccessActivity extends FincBaseActivity {
	private final String TAG = "FincChangCardSuccessActivity";
	/** 基金持仓主view */
	...
	private void init() {
		myFincView = mainInflater.inflate(
				R.layout.finc_chang_card_success, null);
