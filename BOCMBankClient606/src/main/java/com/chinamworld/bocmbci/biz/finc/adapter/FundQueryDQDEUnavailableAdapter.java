 ...
 * 
 */
public class FundQueryDQDEUnavailableAdapter extends BaseAdapter {

	private Context context;
	private LayoutInflater mInflater;
	private List<Map<String, Object>> list;

	public FundQueryDQDEUnavailableAdapter(Context context,
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		final String transType = (String) map.get(Finc.APPLYTYPE);
		holder.mApplayDateTv.setText(StringUtil.valueOf1(applyDate));
		holder.mFundNameTv.setText(StringUtil.valueOf1(fundName));
		holder.mTradetypeTv.setText(StringUtil.valueOf1((String)LocalData.applyTypeMap.get(transType)));
