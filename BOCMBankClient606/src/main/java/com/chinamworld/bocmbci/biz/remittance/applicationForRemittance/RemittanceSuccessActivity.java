 ...
 * @author Zhi
 */
public class RemittanceSuccessActivity extends RemittanceBaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		addView(R.layout.remittance_success);
...
//		setRightTopGone();
	...
	private void initView() {
		...
		((TextView) findViewById(R.id.tv_gatheringArea)).setText(RemittanceDataCenter.payeeArea.
					get(RemittanceDataCenter.payeeAreaCode.indexOf(params.get(Remittance.GATHERINGAREA))));
		...
		if (params.get(Remittance.GATHERINGAREA).equals("JP") || params.get(Remittance.GATHERINGAREA).equals("日本") ) {
...
//		((TextView) findViewById(R.id.tv_payeeEnAddress)).setText((String) params.get(Remittance.PAYEEENADDRESS)));
		...
		findViewById(R.id.btnFinish).setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				setResult(QUIT_CODE);
				finish();
				Intent intent = new Intent(RemittanceSuccessActivity.this, RemittanceInfoInputActivity.class).putExtra("ISSHOWMUSTKNOW", false);
