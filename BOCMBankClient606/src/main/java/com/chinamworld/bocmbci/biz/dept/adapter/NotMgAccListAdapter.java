...
public class NotMgAccListAdapter extends BaseAdapter {
	...
	public NotMgAccListAdapter(Context context,
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		TextView backTitle = (TextView) convertView
				.findViewById(R.id.text_back_title);
		backTitle.setText(R.string.notify_detail);
