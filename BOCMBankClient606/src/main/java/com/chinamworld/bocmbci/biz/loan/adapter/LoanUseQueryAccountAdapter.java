...
public class LoanUseQueryAccountAdapter extends BaseAdapter {
	private List<Map<String, String>> list = null;
	private Context context = null;
	public static int selection = -1;

	public LoanUseQueryAccountAdapter(Context context, List<Map<String, String>> list) {
		this.list = list;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			holder.loanCodeTitleText = (TextView) convertView.findViewById(R.id.loan_choise_code);
			holder.loan_repay_money = (TextView) convertView.findViewById(R.id.loan_repay_money);
		...
		String currency = map.get(Loan.LOANACC_CURRENCYCODE_RES);
		String number = null;
		...
		holder.loan_repay_money.setText(R.string.loan_choise_pa_moneys);
		...
		holder.loanCodeTitleText.setText(R.string.bizhong);
		return convertView;
	}
	...
	private class ViewHolder {
		...
		private TextView loanCodeTitleText = null;
		private TextView loan_repay_money = null;
