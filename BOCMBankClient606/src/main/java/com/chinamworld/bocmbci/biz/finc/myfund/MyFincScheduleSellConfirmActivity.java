...
//					.get(Finc.FINC_FUNDINFO_REQ);
	...
	public void fincScheduSellCallback(Object resultObj) {
		super.fincScheduSellCallback(resultObj);
		...
		// 跳转到基金卖出成功页面
		Intent intent = new Intent(MyFincScheduleSellConfirmActivity.this,
				MyFincScheduleSellSuccessActivity.class);
