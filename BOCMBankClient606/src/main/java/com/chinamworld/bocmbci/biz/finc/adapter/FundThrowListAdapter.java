 ...
 * 
 */
public class FundThrowListAdapter extends BaseAdapter {
	...
	public FundThrowListAdapter(Context context, List<Map<String, Object>> list) {
		super();
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		Map<String,Object> fundInfoMap = (Map<String, Object>) map.get(Finc.FINC_FUNDINFO_REQ);
//		final String fundCode = (String) fundInfoMap.get(Finc.FINC_FUNDCODE);
		final String fundName = (String) fundInfoMap.get(Finc.FINC_FUNDNAME_REQ);
		final String risk = (String) fundInfoMap.get(Finc.FINC_RISKLV);
		
		holder.fundCodeTextView.setText(fundName);
		holder.risklevelTextView.setText(LocalData.fincRiskLevelCodeToStrFUND.get(risk));
