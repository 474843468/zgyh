 ...
 * 
 */
public class PrmsAccActivity401 extends PrmsBaseActivity implements OnClickListener {
	/**
	 * 我的账户贵金属
	 */
	private static final String TAG = "PrmsAccActivity401";
	/**
	 * 显示贵金属账户的View
	 */
	...
	public void queryPrmsAccBalanceCallBack(Object resultObj) {
		...
		dataList = getAccData(prmsControl.accBalanceList, 1);
		BaseHttpEngine.dissMissProgressDialog();
	...
	void init() {
		...
		resetOnClickListener = new OnClickListener() {
			...
			public void onClick(View v) {
				PrmsAccActivity401.this.accBalanceDialog.dismiss();
				BaseHttpEngine.showProgressDialog();
				queryPrmsAccs();
			}
		};
