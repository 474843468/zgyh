 ...
 * 
 */
public class PrmsNewBaseActivity extends NewStyleBaseActivity {
	private static final String TAG = "PrmsNewBaseActivity";
...
//	protected Button back;
	...
	//更多中买入，卖出，行情页进入的时候，买卖完成跳到行情页2；
	//优选投资进入的情况1;
	//扫描二维码，跳到详情页面3。
	public static int prmsFlagGoWay = -1;
...
//	 * 贵金属多笔行情查询
//	 */
//	protected void requestQueryMultipleQuotation(String pSort) {
//		BiiRequestBody biiRequestBody = new BiiRequestBody();
...
//	 * 贵金属单笔行情查询
//	 */
//	protected void requestQuerySingelQuotation(String ccygrp) {
//		BiiRequestBody biiRequestBody = new BiiRequestBody();
//		biiRequestBody.setMethod("queryMultipleQuotation");
//		Map<String, Object> map = new HashMap<String, Object>();
//		//ccygrp
...
//
//	/**
//	 * queryKTendency贵金属K线图查询
//	 */
//	protected void requestqueryKTendency(String ccygrp,String kType,String timeZone) {
//		BiiRequestBody biiRequestBody = new BiiRequestBody();
//		biiRequestBody.setMethod("queryMultipleQuotation");
//		Map<String, Object> map = new HashMap<String, Object>();
//		//ccygrp
...
//
//	/**
//	 * 贵金属趋势图查询queryAverageTendency
//	 */
//	protected void requestqueryAverageTendency(String ccygrp,String tendencyType) {
//		BiiRequestBody biiRequestBody = new BiiRequestBody();
//		biiRequestBody.setMethod("queryMultipleQuotation");
//		Map<String, Object> map = new HashMap<String, Object>();
//		//ccygrp
...
//		parms_map.put(Tran.ACCOUNTTYPE_REQ, accountTypeArr);
