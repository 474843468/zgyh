 ...
 * 下拉刷新布局
 */
public class GoldPullToRefreshLayout extends FrameLayout {
    ...
    public GoldPullToRefreshLayout(Context context) {
        super(context);
        initView(context);
    }

    public GoldPullToRefreshLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView(context);
    }

    public GoldPullToRefreshLayout(Context context, AttributeSet attrs, int defStyle) {
    ...
    public PullPinnedSectionListView getPullPinnedSectionListView(){
        return (PullPinnedSectionListView)pullableView;
    }


    private void initView(Context context) {
        pullableView = new PullPinnedSectionListView(context);
        super.addView((View)pullableView);
