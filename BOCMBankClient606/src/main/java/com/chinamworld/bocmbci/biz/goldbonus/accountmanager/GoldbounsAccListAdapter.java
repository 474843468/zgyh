 ...
 * 
 */
public class GoldbounsAccListAdapter extends BaseAdapter {
	private Context mContext;
	private List<Map<String, Object>> mList;
	private int selectedPosition = -1;

	public GoldbounsAccListAdapter(Context context, List<Map<String, Object>> list) {
		mContext = context;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = LayoutInflater.from(mContext).inflate(
					R.layout.goldstoreaccchose_list_item, null);
