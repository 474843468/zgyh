 ...
 * 
 */
public class ZextendAgreeSuccessActivity extends BociBaseActivity {
	@Override
	...
	private void init() {
		...
		tv_title.setText(zidongeditSuccessList.get(Integer.valueOf(this
		...
		btn_next.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				Intent intent = new Intent(ZextendAgreeSuccessActivity.this,
