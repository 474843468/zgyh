...
/** 信用卡已出账单查询明细页面 */
public class CreditCardStatementDetailActivity extends BocnetBaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		transList = (List<Map<String, String>>) transMap.get(Bocnet.TRANSLIST);
	...
	private void init() {
		resultView = findViewById(R.id.acc_query_result_layout);
		...
		crcd_forei_ying_huan_tag = (TextView) findViewById(R.id.crcd_forei_ying_huan);
