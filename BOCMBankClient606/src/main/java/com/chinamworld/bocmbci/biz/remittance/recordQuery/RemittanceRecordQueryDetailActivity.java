 ...
 * @author Zhi
 */
public class RemittanceRecordQueryDetailActivity extends RemittanceBaseActivity {
	/** 收款人常驻国家(地址) */
	...
	private void initView() {
		Map<String, Object> detailMap = RemittanceDataCenter.getInstance()
				.getMapPsnTransQueryTransferRecordDetail();
		//增加气泡显示
		PopupWindowUtils.getInstance().setOnShowAllTextListener(this,(TextView) findViewById(R.id.tv_batSeq));
		PopupWindowUtils.getInstance().setOnShowAllTextListener(this,(TextView) findViewById(R.id.tv_transactionId));
		PopupWindowUtils.getInstance().setOnShowAllTextListener(this,(TextView) findViewById(R.id.tv_payeeEnName));
		PopupWindowUtils.getInstance().setOnShowAllTextListener(this,(TextView) findViewById(R.id.tv_payeeAddress));
		PopupWindowUtils.getInstance().setOnShowAllTextListener(this,(TextView) findViewById(R.id.tv_payeeBankName));
		PopupWindowUtils.getInstance().setOnShowAllTextListener(this,(TextView) findViewById(R.id.tv_tranDate));
		PopupWindowUtils.getInstance().setOnShowAllTextListener(this,(TextView) findViewById(R.id.tv_execution_style));
		...
		((TextView) findViewById(R.id.tv_swiftAccountNumber))
				.setText(StringUtil.getForSixForString((String) detailMap.get(Remittance.PAYERACCOUNTNUMBER)));
		...
		((TextView) findViewById(R.id.tv_payeeEnName))
				.setText((String) detailMap.get(Remittance.PAYEEACCOUNTNAME));// 收款人名称没有
		...
		((TextView) findViewById(R.id.tv_payeeActno))
				.setText(StringUtil.getForSixForString((String) detailMap.get(Remittance.PAYEEACCOUNTNUMBER)));
		...
		((TextView) findViewById(R.id.tv_transferAmount)).setText(StringUtil
				.parseStringCodePattern((String) detailMap.get(Remittance.FEECUR),(String) detailMap.get(Remittance.AMOUNT),
						2));
		...
		((TextView) findViewById(R.id.tv_transFee)).setText(StringUtil
				.parseStringCodePattern(
						(String) detailMap.get(Remittance.FEECUR2),
						handling_charge, 2));
