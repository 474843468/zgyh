...
public class Switch extends CompoundButton {
    ...
    public Switch(Context context, AttributeSet attrs, int defStyle) {
        ...
        mTrackDrawable = a.getDrawable(R.styleable.Switch_lianlong_track);
        mTextOn = a.getText(R.styleable.Switch_lianlong_textOn);
        mTextOff = a.getText(R.styleable.Switch_lianlong_textOff);
        mThumbTextPadding = a.getDimensionPixelSize(
                R.styleable.Switch_lianlong_thumbTextPadding, 0);
        mSwitchMinWidth = a.getDimensionPixelSize(
                R.styleable.Switch_lianlong_switchMinWidth, 0);
        mSwitchPadding = a.getDimensionPixelSize(
                R.styleable.Switch_lianlong_switchPadding, 0);


        int appearance = a.getResourceId(
                R.styleable.Switch_lianlong_switchTextAppearance, 0);
        if (appearance != 0) {
   ...
   /* @Override
    public boolean dispatchTouchEvent(MotionEvent event) {
        LogGloble.d("SvenDebug", "dispatchTouchEvent:action=" + event.getAction());
        return false;
    }*/
