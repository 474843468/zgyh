...
public class ECharsView extends WebView {
    ...
    public ECharsType getECharsType(){
        return mECharsType;
    }
...
//                }
                ...
                // 页面加载完成后再调用JS方法
                if (newProgress == 100) {
                    loadUrl("javascript:draw('" + result  + "','"
                            + "default" + "')");
                }
    ...
    private String initThreeData(IECharsData... data){
        if(data == null || data.length < 3)
            return "";
        getMaxAndMin(false,data);
//        String s = "{\"tooltip\":{\"trigger\":\"axis\",\"axisPointer\":{\"type\":\"line\",\"lineStyle\" : {\"color\": \"rgba(202,202,202,1)\",\"width\": 1,\"type\": \"solid\"}},"
...
//                +"\"axisLabel\": {\"formatter\":\"{value}\",\"textStyle\":{\"color\":\"rgba(165,161,161,0.9)\",\"fontSize\":9}},\"axisTick\":{\"show\":false},\"data\":%s}],\"yAxis\":[{\"max\":%f,\"min\":%f,\"type\":\"value\", \"splitNumber\":4,\"splitLine\":{\"show\":false},"
...
//
//        String result = String.format(s,GsonTools.toJson(data[0].getXList()),mMax,mMin,GsonTools.toJson(data[0].getYList()),GsonTools.toJson(data[1].getYList()),data[2].getTitle(),GsonTools.toJson(data[2].getYList()));
        ...
        String result = String.format(s,GsonTools.toJson(data[0].getXList()),GsonTools.toJson(data[0].getYList()),GsonTools.toJson(data[1].getYList()),data[2].getTitle(),GsonTools.toJson(data[2].getYList()));
    ...
    private String initQuShiData(IECharsData... data){
        ...
        String s = "{\"tooltip\":{\"trigger\":\"axis\",\"axisPointer\":{\"type\":\"line\",\"lineStyle\" : {\"color\": \"rgba(202,202,202,1)\",\"width\": 1,\"type\": \"solid\"}},"
                ...
                +"\"series\":[{\"name\":\"%s\",\"type\":\"line\",\"symbol\":\"none\",\"itemStyle\": {\"normal\":{\"lineStyle\":{\"color\":\"rgba(154,181,238,1)\"},\"areaStyle\":{\"type\":\"default\",\"color\":\"rgba(201,220,249,1)\"}}},\"data\":%s}]}";

        String result = String.format(s,GsonTools.toJson(data[0].getXList()),title,GsonTools.toJson(data[0].getYList()));
    ...
    private String initZheXianData(IECharsData... data){
        ...
        String s = "{\"tooltip\":{\"trigger\":\"axis\",\"axisPointer\":{\"type\":\"line\",\"lineStyle\" : {\"color\": \"rgba(202,202,202,1)\",\"width\": 1,\"type\": \"solid\"}},"
                ...
                +"\"axisLabel\": {\"formatter\":\"{value}\",\"textStyle\":{\"color\":\"rgba(165,161,161,0.9)\",\"fontSize\":9}},\"axisTick\":{\"show\":false},\"data\":%s}],\"yAxis\":[{\"type\":\"value\",\"splitNumber\":4,\"splitLine\":{\"show\":false},"
                +"\"axisTick\":{\"show\":false},\"axisLine\":{\"lineStyle\": {\"color\":\"rgba(202,202,202,1)\",\"width\":0.5}},\"axisLabel\": {\"formatter\":\"{value}\",\"textStyle\":{\"color\":\"rgba(165,161,161,0.9)\",\"fontSize\":9}}}],"
                +"\"series\":[{\"name\":\"%s\",\"type\":\"line\",\"symbol\":\"none\",\"itemStyle\": {\"normal\":{\"lineStyle\":{\"color\":\"rgba(154,181,238,1)\"},\"areaStyle\":{\"type\":\"default\",\"color\":\"rgba(255,255,255,1)\"}}},\"data\":%s}]}";
    ...
    private String initZheXianDianData(IECharsData... data){
        ...
        String s = "{\"tooltip\":{\"trigger\":\"axis\",\"axisPointer\":{\"type\":\"line\",\"lineStyle\" : {\"color\": \"rgba(202,202,202,1)\",\"width\": 1,\"type\": \"solid\"}},"
                ...
                +"\"axisLabel\": {\"formatter\":\"{value}\",\"textStyle\":{\"color\":\"rgba(165,161,161,0.9)\",\"fontSize\":9}},\"axisTick\":{\"show\":false},\"data\":%s}],\"yAxis\":[{\"type\":\"value\",\"splitNumber\":4,\"splitLine\":{\"show\":false},"
                +"\"axisTick\":{\"show\":false},\"axisLine\":{\"lineStyle\": {\"color\":\"rgba(202,202,202,1)\",\"width\":0.5}},\"axisLabel\": {\"formatter\":\"{value}\",\"textStyle\":{\"color\":\"rgba(165,161,161,0.9)\",\"fontSize\":9}}}],"
                +"\"series\":[{\"name\":\"%s\",\"type\":\"line\",\"symbol\":\"circle\",\"symbolSize\":1,\"itemStyle\": {\"normal\":{\"lineStyle\":{\"color\":\"rgba(154,181,238,1)\"},\"areaStyle\":{\"type\":\"default\",\"color\":\"rgba(255,255,255,1)\"}}},\"data\":%s}]}";
    ...
    private String initMutilTitleLineData(IECharsData... data) {
        if(data ==null || data.length < 3)
            return "";
        getMaxAndMin(true,data);
        String s = "{\"tooltip\":{\"trigger\":\"axis\",\"axisPointer\":{\"type\":\"line\",\"lineStyle\" : {\"color\": \"rgba(202,202,202,1)\",\"width\": 1,\"type\": \"solid\"}},\"formatter\":\"{b}</br>{a}:{c}</br>{a1}:{c1}/{c2}\", \"backgroundColor\":\"rgba(175,198,248,0.9)\",\"textStyle\":{\"color\":\"rgba(255,255,255,1)\",\"fontSize\":9}},\"calculable\":false,\"grid\":{\"borderWidth\":0,\"x\":40,\"y\":10,\"x2\":40,\"y2\":20},\"xAxis\":[{\"type\":\"category\",\"boundaryGap\":false,\"splitLine\":{\"show\":false}," +
                "\"axisTick\":{\"show\":false},\"axisLine\":{\"lineStyle\": {\"color\":\"rgba(165,161,161,1)\",\"width\":0.5}},\"axisLabel\": {\"formatter\":\"{value}\",\"textStyle\":{\"color\":\"rgba(165,161,161,0.9)\",\"fontSize\":9}},\"axisTick\":{\"show\":false},\"data\":%s}],\"yAxis\":[{ \"max\":%.0f,\"min\":%.0f,\"type\":\"value\",\"splitNumber\":4,\"splitLine\":{\"show\":false},\"axisTick\":{\"show\":false},\"axisLine\":{\"lineStyle\": {\"color\":\"rgba(165,161,161,1)\",\"width\":0.5}},\"axisLabel\": {\"formatter\":\"{value}\"," +
        ...
        String result = String.format(s,GsonTools.toJson(data[0].getXList()),mMax,mMin,GsonTools.toJson(data[0].getYList()),GsonTools.toJson(data[1].getYList()),GsonTools.toJson(data[2].getYList()));
...
//
//
//        String result = String.format(s,GsonTools.toJson(data[0].getXList()),100,0,GsonTools.toJson(data[0].getYList()),GsonTools.toJson(data[1].getYList()),GsonTools.toJson(data[2].getYList()));
    ...
    /**
     *
     * @param isOneLine 是否三条线只显示一条 如基金的排名变化为true
     * @param datas
     */
    private void getMaxAndMin(boolean isOneLine,IECharsData... datas){
        double max = -9999999 ,min = 99999999,tmp;
        if(isOneLine){
            tmp = getMax(datas[0].getYList());
            if(max < tmp)
                max = tmp;
            tmp = getMin(datas[0].getYList());
            if(tmp < min)
                min = tmp;
        }else{
