 ...
 */
public abstract class MAAsyncTask<Params, Progress, Result> {
...
//    public static final Executor SERIAL_EXECUTOR = MAVersionUtils.laterThanHoneycomb() ? new SerialExecutor() :
//    	Executors.newSingleThreadExecutor(sThreadFactory);//change by lgw 2015.10.28 由于要使用SDK 2.3.3(Android 10) 编译 
     ...
     *         {@link MAAsyncTask.Status#RUNNING} or {@link MAAsyncTask.Status#FINISHED}.
     *
     * @see #executeOnExecutor(java.util.concurrent.Executor, Object[])
     * @see #execute(Runnable)
     */
    public final MAAsyncTask<Params, Progress, Result> execute(Params... params) {
     ...
     * @see #execute(Object[])
     */
    public final MAAsyncTask<Params, Progress, Result> executeOnExecutor(Executor exec,
            Params... params) {
    ...
    private static class AsyncTaskResult<Data> {
        final MAAsyncTask mTask;
        final Data[] mData;

        AsyncTaskResult(MAAsyncTask task, Data... data) {
            mTask = task;
            mData = data;
        }
    }
