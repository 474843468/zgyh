 ...
 */
public class PsnDirTransCrossBankTransferResult {

    /**
     * smcTrigerInterval : null
     * factorList : [{"field":{"name":"_signedData","type":"hidden"}}]
     * _plainData : <?xml version="1.0" encoding="UTF-8"?><R xml:lang="zh_CN"><S><I k="fromAccountId" c="s"><T>转出账户标识</T><D>100032106</D></I><V k="payeeActno" c="s"><T>收款人账号</T><D>54522222104</D></V><V k="payeeName" c="s"><T>收款人姓名</T><D>pseudo</D></V><V k="amount" c="s"><T>转账金额</T><D>300.55</D></V><I k="userId"><D>gryh0025</D></I><I k="timestamp"><D>2011-04-22 16:27:44.796</D></I></S></R>
