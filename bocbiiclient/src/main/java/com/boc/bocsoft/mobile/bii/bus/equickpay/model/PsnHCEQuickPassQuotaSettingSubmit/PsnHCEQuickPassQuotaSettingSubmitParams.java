package com.boc.bocsoft.mobile.bii.bus.equickpay.model.PsnHCEQuickPassQuotaSettingSubmit;

/**
 * Created by yangle on 2016/12/15.
 * 描述:HCE闪付卡限额设置提交交易params
 */
public class PsnHCEQuickPassQuotaSettingSubmitParams {
