package com.boc.bocsoft.mobile.bii.bus.loan.model.PsnLOANChangeLoanERepayAccountVerify;

/**
 * PsnLOANChangeLoanERepayAccountVerify变更中E贷还款账户预交易,请求参数
 * Created by xintong on 2016/6/23.
 */
public class PsnLOANChangeLoanERepayAccountVerifyParams {
    ...
    public String toString() {
        return "PsnLOANChangeLoanERepayAccountVerifyParams{" +
