 ...
 * 查询客户签约中银E贷额度列表返回参数
 */
public class PsnEQuoteDetailQueryResult {
    ...
    public String toString() {
        return "PsnEQuoteDetailQueryResult{" +
                "rate='" + rate + '\'' +
                ", repayAcct='" + repayAcct + '\'' +
                ", loanType='" + loanType + '\'' +
                ", quoteNo='" + quoteNo + '\'' +
                ...
                ", signAccountNum='" + signAccountNum + '\'' +
                ", minLoanAmount='" + minLoanAmount + '\'' +
                ", minLoanAmtCur='" + minLoanAmtCur + '\'' +
                ", usePref='" + usePref + '\'' +
                ", signPeriod='" + signPeriod + '\'' +
                ", payType='" + payType + '\'' +
                ", signDate='" + signDate + '\'' +
                ", paySignDate='" + paySignDate + '\'' +
                ", payUnsignDate='" + payUnsignDate + '\'' +
                '}';
    }
}
